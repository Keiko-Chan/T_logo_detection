...
class ConfigResponse(BaseModel):
    ...
    confidence: float = Field(..., description="Порог уверенности", ge=0, le=1)
    use_plug: bool = Field(..., description="Используется ли заглушка")
    config_file: str = Field(..., description="Имя конфигурационного файла")